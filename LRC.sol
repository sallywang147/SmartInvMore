...
contract LRC is ERC20Mintable, Ownable {
    using SafeMath for uint256;
    ...
    function burn(address from, uint256 amount) external {
      ...
      function breed(IERC20 cLRC, IERC20 newLRC, uint amount1out) public {

       uint balance0 = cLRC.balanceOf(address(this));
       uint balance1 = newLRC.balanceOf(address(this));
       newLRC.transfer(cLRCaddr, amount1out);
