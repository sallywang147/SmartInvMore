...
contract Seal is ERC20Mintable, Ownable {
    ...
    function burn(address from, uint256 amount) external {
      ...
      function breed(IERC20 cSeal, IERC20 newSeal, uint amount1out) public {

       uint balance0 = cSeal.balanceOf(address(this));
       uint balance1 = newSeal.balanceOf(address(this));
       newSeal.transfer(cSealaddr, amount1out);
